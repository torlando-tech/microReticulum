...
> **Note:** This is a reference copy from `.planning/phases/03-memory-allocation-audit/03-AUDIT.md`.
> The source file in the planning directory is the source of truth.
