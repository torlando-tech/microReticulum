...
must_haves:
  truths:
    - "All 31 issues from Phases 3-4 are present in the backlog"
...
Output: BACKLOG.md with 31 issues, WSJF scores, and fix recommendations ordered by priority
</objective>
...
Note: Phase 4 summary lists 18 issues but detailed enumeration shows 17. Count from source documents and reconcile in the backlog.
...
- Include Phase 1-2 instrumentation (those were tools, not issues)
  ...
  <verify>
- Count issues in BACKLOG.md: should be 31 (or reconciled count from Phase 4)
...
<success_criteria>
- [ ] BACKLOG.md contains all 31 issues (or reconciled count)
